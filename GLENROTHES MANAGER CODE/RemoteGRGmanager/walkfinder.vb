...
Public Class walkfinder
    ...
    Private Sub walkfinder_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.PUBLISHEDTableAdapter.FillByWF(Me.Chrisbarton_grg10DataSet3.PUBLISHED)
    ...
    Private Sub getPeriods()
        Try
            Dim lastix As Integer = Chrisbarton_grg10DataSet3.PUBLISHED.Rows.Count - 1
            period = Chrisbarton_grg10DataSet3.PUBLISHED(lastix).period
    ...
    Private Sub makeCSV()
        ...
        For ix = 1 To Chrisbarton_grg10DataSet3.PUBLISHED.Rows.Count - 1
    ...
    Private Sub ToolStripButton1_Click(sender As Object, e As EventArgs) Handles tsbSave.Click
        sfdlg.FileName = "CF04_" & period.Trim(" ") & ".csv"
